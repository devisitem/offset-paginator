...
import pagination.validator.CommonValidator;
...
public abstract class AbstractPaginationObject implements PaginationObject {
    ...
    @Override
    public final PaginationObject initialize(int totalContentsCount, int numPerPage, int contentsPerPage, int currentPage) throws Throwable {
