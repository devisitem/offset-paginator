...
public abstract class AbstractCommonCalculator {
    ...
    protected abstract int calStartPage(int totalPageCnt, int currentPage, int numSizePerPage, int currentStep) throws Exception;
    ...
    protected abstract void calMove(PaginationObject object, AbstractCommonCalculator calculator, int currentStep, int totalStepCnt, int numSizePerPage) throws Exception;

    protected void calAbleToNext(PaginationObject object) throws Exception {
    ...
    protected final int getValue(CalculateConstant constant) throws Exception{
